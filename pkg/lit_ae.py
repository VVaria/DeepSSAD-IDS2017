...
class LitIDSAE(pl.LightningModule):

    def __init__(self, sip_map, dip_map, z_dim, hidden_dim=512, continuous_dim=128, 
                 ip_dim = 12, port_dim = 16, protocol_dim = 2, use_category=True,
        ...
        self.save_hyperparameters('z_dim', 'hidden_dim', 'continuous_dim', 
                                  'ip_dim', 'port_dim', 'protocol_dim', 'lr', 'weight_decay', 'use_category')
    ...
    def training_step(self, batch, batch_idx):
        ...
        mse = F.mse_loss(continuous_hat, continuous)
        loss += mse
